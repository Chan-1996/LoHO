...
TAG=${TAG:-k${K}-${MODEL_NAME}-weight-bybrid-mezo-adam-last12layer-ratio60-linear-fo-lr-no-dropout-${EXTRA_TAG}}
...
TYPE=prompt GRID_TAG=$GR_TAG TAG=$TAG STEPS=$STEP TASK=$TASK SEED=$SEED MODEL=$MODEL K=$K \
      ...
      --zo_combine_fo --weight_wise_hybrid --masking_prob 0.5 \
      --fo_optim_layers "layer.12." "layer.13." "layer.14." "layer.15." "layer.16." "layer.17." "layer.18." "layer.19." "layer.20." "layer.21." "layer.22." "layer.23." \
